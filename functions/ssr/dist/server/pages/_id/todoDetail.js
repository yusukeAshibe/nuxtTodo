...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_id/todoDetail.vue?vue&type=template&id=c7b788b4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',[_c('div',[_vm._v("タスク詳細ページ。 id:"+_vm._s(_vm.id))]),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('v-text-field',{attrs:{"placeholder":"タスク","outlined":"","counter":100},model:{value:(_vm.text),callback:function ($$v) {_vm.text=$$v},expression:"text"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('v-textarea',{attrs:{"label":"メモ","outlined":"","counter":1000},model:{value:(_vm.memo),callback:function ($$v) {_vm.memo=$$v},expression:"memo"}}),_vm._v(" "),_c('v-btn',{attrs:{"depressed":"","color":"primary"},on:{"click":function($event){$event.stopPropagation();return _vm.update()}}},[_vm._v("保存")])],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12"}},[_c('div',[_vm._v("登録日時："+_vm._s(_vm.ViewRegisterDate(this.registerDate)))]),_vm._v(" "),_c('div',[_vm._v("更新日時："+_vm._s(_vm.ViewUpdateDate(this.finishDate)))])])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_id/todoDetail.vue?vue&type=template&id=c7b788b4&
...
var external_dayjs_ = __webpack_require__(196);
var external_dayjs_default = /*#__PURE__*/__webpack_require__.n(external_dayjs_);

// EXTERNAL MODULE: external "dayjs/locale/ja"
var ja_ = __webpack_require__(98);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_id/todoDetail.vue?vue&type=script&lang=ts&



/* harmony default export */ var todoDetailvue_type_script_lang_ts_ = (external_vue_default.a.extend({
  data() {
    return {
      id: 0,
      text: "",
  ...
  created() {
    ...
    const searchTodo = this.$accessor.todo.todos.find(todos => todos.id == this.id);

    if (searchTodo) {
      this.id = searchTodo.id;
      this.text = searchTodo.text;
      this.done = searchTodo.done;
      this.memo = searchTodo.memo;
      this.registerDate = searchTodo.registerDate;
      this.finishDate = searchTodo.finishDate;
    }
  },
  ...
  methods: {
    ...
    ViewRegisterDate(registerDate) {
      console.log("mesoddo");
      return external_dayjs_default()(registerDate).locale("ja").format("YYYY/MM/DD(dd) HH:mm:ss");
    },

    ViewUpdateDate(finishDate) {
      return external_dayjs_default()(finishDate).locale("ja").format("YYYY/MM/DD(dd) HH:mm:ss");
    }

  }
}));
// CONCATENATED MODULE: ./pages/_id/todoDetail.vue?vue&type=script&lang=ts&
 /* harmony default export */ var _id_todoDetailvue_type_script_lang_ts_ = (todoDetailvue_type_script_lang_ts_); 
...
// CONCATENATED MODULE: ./pages/_id/todoDetail.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _id_todoDetailvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var todoDetail = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VApp: VApp["a" /* default */],VBtn: VBtn["a" /* default */],VCol: VCol["a" /* default */],VTextField: VTextField["a" /* default */],VTextarea: VTextarea["a" /* default */]})
