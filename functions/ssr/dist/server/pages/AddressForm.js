...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/AddressForm.vue?vue&type=template&id=6f226ff5&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"text-xs-center":""}},[_c('v-layout',{attrs:{"row":"","wrap":"","justify-center":""}},[_c('v-flex',{staticClass:"text-center",attrs:{"xs12":""}},[_c('h1',[_vm._v("連絡先編集")])]),_vm._v(" "),_c('v-flex',{attrs:{"xs5":"","mt-5":""}},[_c('v-card',[_c('v-card-text',[_c('v-form',[_c('v-text-field',{attrs:{"label":"名前"},model:{value:(_vm.address.name),callback:function ($$v) {_vm.$set(_vm.address, "name", $$v)},expression:"address.name"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"電話番号"},model:{value:(_vm.address.tel),callback:function ($$v) {_vm.$set(_vm.address, "tel", $$v)},expression:"address.tel"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"メールアドレス"},model:{value:(_vm.address.email),callback:function ($$v) {_vm.$set(_vm.address, "email", $$v)},expression:"address.email"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"住所"},model:{value:(_vm.address.address),callback:function ($$v) {_vm.$set(_vm.address, "address", $$v)},expression:"address.address"}}),_vm._v(" "),_c('div',{staticClass:"text-center"},[_c('Nuxt-link',[_c('v-btn',[_vm._v("キャンセル")])],1),_vm._v(" "),_c('Nuxt-link',[_c('v-btn',{staticClass:"ml-2",attrs:{"color":"info"},on:{"click":_vm.submit}},[_vm._v("保存")])],1)],1)],1)],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/AddressForm.vue?vue&type=template&id=6f226ff5&

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(28);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/AddressForm.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var AddressFormvue_type_script_lang_js_ = ({
  created() {
  ...
  methods: {
    ...
    ...Object(external_vuex_["mapActions"])(["addAddress", "updateAddress"])
  }
});
// CONCATENATED MODULE: ./pages/AddressForm.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_AddressFormvue_type_script_lang_js_ = (AddressFormvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/AddressForm.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_AddressFormvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardText: components_VCard["a" /* VCardText */],VContainer: VContainer["a" /* default */],VFlex: VFlex["a" /* default */],VForm: VForm,VLayout: VLayout["a" /* default */],VTextField: VTextField["a" /* default */]})
